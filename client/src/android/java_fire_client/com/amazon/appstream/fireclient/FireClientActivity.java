...
import com.amazon.appstream.JoystickHelper;
 ...
 * layer.
 */
public class FireClientActivity
    ...
    private static final String TAG = "FireClientActivity";
    ...
    boolean mInitializedJoystick = false;
    int mLTrigger = MotionEvent.AXIS_BRAKE;
    int mRTrigger = MotionEvent.AXIS_GAS;
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        if (event.getSource() == InputDevice.SOURCE_MOUSE) {
            ...
            if (!mInitializedJoystick) {
                ...
                InputDevice.MotionRange lThumbX = joystick.getMotionRange(MotionEvent.AXIS_X, InputDevice.SOURCE_JOYSTICK);
                InputDevice.MotionRange lThumbY = joystick.getMotionRange(MotionEvent.AXIS_Y, InputDevice.SOURCE_JOYSTICK);
