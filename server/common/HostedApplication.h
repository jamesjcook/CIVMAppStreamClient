...
public:
     ...
     * of an instance of HostedApplication.
    ...
    /**
     * Tell the hosted application to start.
     * @return Returns XSTX_RESULT_OK if the operation is successful.
     */
     ...
     */
    virtual XStxIServerListener2* getServerListener() = 0;
    ...
    /**
     * The game wants to post a new frame.
     */
    virtual void postNewFrame(const unsigned char* theFrame, CapturePixelFormat pixelformat);
...
protected:
    ...
    HostedApplication() {};
    HostedApplication(const HostedApplication&) {};
    HostedApplication& operator=(const HostedApplication&) {};

};

inline void HostedApplication::postNewFrame(const unsigned char* theFrame, CapturePixelFormat pixelformat) {}
